...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["CottsResearch.com"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="TemperatureLogger <noreply@CottsResearch.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[TemperatureLogger]"
)
